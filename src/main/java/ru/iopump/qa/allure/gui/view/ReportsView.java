...
@Route(value = "reports-view", layout = ReportsMain.class)
@Slf4j
public class ReportsView extends VerticalLayout {
    ...
    public ReportsView(final JpaReportService jpaReportService,
        ...
        // Применение класса для изменения фона таблицы
    ...
    private static ListDataProvider<ReportEntity> asProvider(final JpaReportService jpaReportService,ReportProperties reportProperties) {
        ...
        List<ReportEntity> sortedList = collection.stream()
                .sorted(Comparator.comparing(reportEntity -> {
                    if (reportEntity.getUuid().equals(UUID.fromString(reportProperties.getYourProperty()))) {
    ...
    public void postConstruct() {
        ...
        mainLayout.setFlexGrow(1, gridContainer);
