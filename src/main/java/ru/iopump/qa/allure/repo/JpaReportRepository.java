...
public interface JpaReportRepository extends JpaRepository<ReportEntity, UUID> {
    ...
    @NonNull
    List<ReportEntity>findByPathStartsWithIgnoreCaseOrderByCreatedDateTimeDesc(String path);

    @NonNull
    List<ReportEntity> findByPathContainingIgnoreCaseOrderByCreatedDateTimeDesc(String part);
}
