// src/pages/ReportsColvir.tsx
/* -----------------------------------------------------------------------
 *  src/pages/ReportsColvir.tsx
 *  Страница «Отчёты Colvir» (полная версия) с унифицированным хедером
 * --------------------------------------------------------------------- */
...
/* ===================== Компонент =================== */
export default function ReportsColvir() {
  ...
  const loadRows = useCallback(() => {
    setLoad(true);
    fetchJSON<Report[]>('/api/reports?path=colvir')
      .then(setRows)
      .catch(() => setRows([]))
